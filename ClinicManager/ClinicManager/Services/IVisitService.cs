...
public interface IVisitService
{
    ...
    Task<IReadOnlyList<VisitDto>> GetForPatientAsync(int patientId, CancellationToken ct = default);
    ...
    Task<bool> ChangeStatusAsync(int id, VisitStatus status, CancellationToken ct = default);
